...
class OCRService:
    ...
    def _estimate_confidence(self, text: str) -> float:
        ...
        allowed_chars = set(string.ascii_letters + string.digits + string.whitespace + string.punctuation + "áéíóúÁÉÍÓÚñÑüÜ")
    ...
    async def extract_text_from_image(self, image: Image.Image, preprocess: bool = True) -> OCRResult:
