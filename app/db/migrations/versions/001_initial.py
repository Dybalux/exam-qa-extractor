...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint('partial_number IN (1, 2, 3, 4)', name='check_valid_partial_number')
    )
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['exam_id'], ['exams.id'], ondelete='CASCADE', name=op.f('fk_exam_images_exam_id_exams')),
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['exam_id'], ['exams.id'], ondelete='CASCADE', name=op.f('fk_questions_exam_id_exams')),
        sa.ForeignKeyConstraint(['image_id'], ['exam_images.id'], ondelete='SET NULL', name=op.f('fk_questions_image_id_exam_images')),
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['question_id'], ['questions.id'], ondelete='CASCADE', name=op.f('fk_answers_question_id_questions')),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_answers')),
        sa.CheckConstraint("answer_type IN ('correct', 'incorrect', 'partial')", name='check_valid_answer_type')
    )
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['exam_id'], ['exams.id'], ondelete='SET NULL', name=op.f('fk_practice_sessions_exam_id_exams')),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_practice_sessions')),
        sa.CheckConstraint("mode IN ('random', 'by_partial', 'by_topic', 'exam_simulation')", name='check_valid_practice_mode')
    )
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['question_id'], ['questions.id'], ondelete='CASCADE', name=op.f('fk_practice_responses_question_id_questions')),
        sa.ForeignKeyConstraint(['retry_of'], ['practice_responses.id'], ondelete='SET NULL', name=op.f('fk_practice_responses_retry_of_practice_responses')),
        sa.ForeignKeyConstraint(['selected_answer_id'], ['answers.id'], ondelete='SET NULL', name=op.f('fk_practice_responses_selected_answer_id_answers')),
        sa.ForeignKeyConstraint(['session_id'], ['practice_sessions.id'], ondelete='CASCADE', name=op.f('fk_practice_responses_session_id_practice_sessions')),
